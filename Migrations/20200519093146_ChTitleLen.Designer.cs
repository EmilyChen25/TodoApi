...
namespace TodoApi.Migrations
{
    ...
    [Migration("20200519093146_ChTitleLen")]
    partial class ChTitleLen
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApi.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TodoApi.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("TodoApi.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TodoApi.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("TodoApi.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("TodoApi.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("TodoApi.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("TodoApi.Models.OfficeAssignment", b =>
                {
                    b.HasOne("TodoApi.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("TodoApi.Models.OfficeAssignment", "InstructorId")
